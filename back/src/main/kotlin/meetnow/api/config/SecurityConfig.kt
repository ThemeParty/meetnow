...
import meetnow.api.auth.CustomAuthenticationEntryPoint
...
class SecurityConfig(
    ...
    private val customAuthenticationEntryPoint: CustomAuthenticationEntryPoint, // CustomAuthenticationEntryPoint 주입
) {
    ...
    fun securityFilterChain(http: HttpSecurity): SecurityFilterChain {
        http
            ...
            .exceptionHandling { handlers ->
                // 예외 처리 설정
                handlers.authenticationEntryPoint(customAuthenticationEntryPoint)
